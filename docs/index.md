---
title:
  page: "NemoClaw Skeleton Developer Guide"
  nav: "NemoClaw"
...
This repository is a hardened NemoClaw skeleton for teams that want to build their own OpenClaw + OpenShell setup.
It runs OpenClaw inside a sandboxed environment with NVIDIA cloud inference through [build.nvidia.com](https://build.nvidia.com).
...
<div class="nc-term">
  ...
  <div class="nc-term-body">
    <div><span class="nc-ps">$ </span>git clone https://github.com/&lt;your-user-or-org&gt;/&lt;your-repo&gt;.git</div>
    <div><span class="nc-ps">$ </span>cd &lt;your-repo&gt;</div>
    <div><span class="nc-ps">$ </span>export NEMOCLAW_OPENSHELL_SHA256=&lt;expected-openshell-archive-sha256&gt;</div>
    <div><span class="nc-ps">$ </span>bash scripts/install.sh</div>
  </div>
</div>
```

Run `nemoclaw --help` in your terminal to view the full CLI reference.
Customize this skeleton for your own repository before publishing it or onboarding collaborators.
...
Run a Hardened NemoClaw Instance <deployment/hardened-instance-runbook>
