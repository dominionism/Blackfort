...
function getOpenshellVersion() {
    try {
        return (0, node_child_process_1.execFileSync)("openshell", ["--version"], { encoding: "utf-8" }).trim();
    }
    catch {
        return "0.0.0";
    }
...
function getOpenclawVersion() {
    try {
        return (0, node_child_process_1.execFileSync)("openclaw", ["--version"], { encoding: "utf-8" }).trim();
    }
    catch {
        return "0.0.0";
    }
